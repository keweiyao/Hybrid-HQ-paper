...
The Fokker-Plank part of the transport equation can be solved by propagating heavy quarks by Langevin equations in between subsequent pQCD scatterings.
...
All the calculation in this section use $\mu =1$ and $\kappa = 0$.
...
we therefore check the range of typical $\alpha_s$ values in the model in order to evaluate the the use of perturbative matrix-elements.
